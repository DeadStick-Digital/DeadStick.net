...
require '<link rel="stylesheet" href="../styles.css?v=20260719-billingbird-iphone">' 'product page should cache-bust its scoped BillingBird styling'
...
require 'alt="BillingBird home screen on iPhone showing Good morning, outstanding balances, and a recent invoice for Cedar Ridge Properties"' 'lead screenshot alt text must match the approved synthetic-data description'
